...
public class sentenceInfoAdpter extends RecyclerView.Adapter<sentenceInfoAdpter.EvaViewHolder> {


    private List<WordQueryBean.TextDataDTO> datas;
    ...
    private int green = Color.parseColor("#5ec662");
    ...
    public sentenceInfoAdpter(List<WordQueryBean.TextDataDTO> datas, Context context) {
        this.datas = datas;
        this.context = context;
    }

    //getItem  手动添加
    public WordQueryBean.TextDataDTO getItem(int position) {
    ...
    public List<WordQueryBean.TextDataDTO> getDatas() {
        return datas;
    }

    public void setDatas(List<WordQueryBean.TextDataDTO> datas) {
        this.datas = datas;
    }
    ...
    public void onBindViewHolder(@NonNull EvaViewHolder holder, int position) {
        ...
        WordQueryBean.TextDataDTO daily = datas.get(position);
...
//        判断点击得段落显示下面得按钮控件
    ...
    class EvaViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout linearLayout,eva_item;
        ...
        public EvaViewHolder(@NonNull View itemView) {
            ...
            eva_item = itemView.findViewById(R.id.item_line);
            ...
            // 原文英语句子
            eva_item.setOnClickListener(new View.OnClickListener() {
                @Override
